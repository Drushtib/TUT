...
const FAQSection = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer: `Our stories blend immersive visuals, vibrant accents, and powerful narratives. Each piece is crafted to ignite curiosity, celebrate vision, and connect dreamers everywhere.`
    }
  ];
    ...
    <>
      ...
      <style jsx>{`
        ...
        .faq-title {
          ...
          margin-bottom: 1rem;
          font-weight: 800;
          text-shadow: 0 2px 10px rgba(218, 0, 55, 0.4);
          position: relative;
        }
        ...
        .faq-item {
          border-bottom: 1px solid rgba(218, 0, 55, 0.3);
          padding: 2rem 0;
        ...
        .faq-item::before {
          ...
          width: 100%;
          height: 100%;
          background: linear-gradient(90deg, transparent, rgba(218, 0, 55, 0.1), transparent);
        ...
        .faq-item:hover .faq-question {
          color: var(--primary-color);
          text-shadow: 0 0 15px rgba(218, 0, 55, 0.4);
        ...
        .faq-item:hover {
          ...
          background: rgba(218, 0, 55, 0.03);
          box-shadow: 0 5px 20px rgba(218, 0, 55, 0.15);
        }
